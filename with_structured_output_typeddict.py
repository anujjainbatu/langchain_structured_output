...
class Review(TypedDict):
    key_themes: Annotated[list[str],"The key themes discussed in the review in a list"]
    summary: Annotated[str,"The summary of the review"]
    sentiment: Annotated[Literal["pos","neg"],"The sentiment of the review"]
    pros: Annotated[Optional[list[str]],"The pros of the product in a list"]
    cons: Annotated[Optional[list[str]],"The cons of the product in a list"]
